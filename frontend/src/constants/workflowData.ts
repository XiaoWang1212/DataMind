...
export const INITIAL_NODES: FlowNode[] = [
  ...
  },
  {
    ...
    data: {
      ...
      fields: [
        { key: 'missing', label: '缺值處理', type: 'select', options: ['drop', 'mean', 'median'] },
        { key: 'scale', label: '標準化', type: 'select', options: ['none', 'standard', 'minmax'] },
      ],
  ...
  },
  {
    ...
    data: {
      ...
      fields: [{ key: 'fitIntercept', label: 'Fit Intercept', type: 'select', options: ['true', 'false'] }],
  ...
  },
  {
    ...
    data: {
      ...
      fields: [
        ...
        { key: 'metric', label: 'Metric', type: 'select', options: ['accuracy', 'f1', 'auc', 'precision', 'recall'] },
      ],
  ...
  },
  {
    ...
    data: {
      ...
      fields: [{ key: 'normalize', label: 'Normalize', type: 'select', options: ['none', 'true', 'pred'] }],
...
export const INITIAL_EDGES: Pick<Edge, 'id' | 'source' | 'target' | 'type'>[] = [
  ...
  { id: 'e2c', source: 'preprocessor',      target: 'modelXgboost',      type: 'default' },
  { id: 'e2d', source: 'preprocessor',      target: 'modelMore',         type: 'default' },
  { id: 'e3a', source: 'modelLinear',        target: 'testScore',         type: 'default' },
  { id: 'e3b', source: 'modelRandomForest',  target: 'testScore',         type: 'default' },
...
export const DEMO_STEPS: DemoStep[] = [
  ...
  { nodeIds: ['modelMore'],         delay: 4200 },
  { nodeIds: ['testScore'],         delay: 5400 },
  { nodeIds: ['confusionMatrix'],   delay: 6600 },
]
