...
from src.rag.deepdoc.parser.resume import refactor
from src.rag.deepdoc.parser.resume import step_one, step_two
...
def chunk(filename, binary=None, callback=None, **kwargs):
    ...
    To maximize the effectiveness, parse the resume correctly, please concat us: https://github.com/infiniflow/aioters_rag
    """
