...
from src.rag.nlp import tokenize, search
...
class Benchmark:
    ...
    def _get_retrieval(self, qrels):
        # Need to wait for the ES index to be ready
        time.sleep(20)
...
if __name__ == '__main__':
    print('*****************AIoTersRAG Benchmark*****************')
    parser = argparse.ArgumentParser(usage="benchmark.py <max_docs> <kb_id> <dataset> <dataset_path> [<miracl_corpus_path>])", description='AIoTersRAG Benchmark')
