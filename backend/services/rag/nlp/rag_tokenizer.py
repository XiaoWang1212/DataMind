...
class RagTokenizer:
    ...
    def __init__(self, debug=False):
        ...
        self.DIR_ = os.path.join(get_project_base_directory(), "src/rag/res", "huqie")
    ...
    def tokenize(self, line):
        ...
        # Convert to traditional Chinese to match the dictionary
        line = self._simp2tradi(line)
...
simp2tradi = tokenizer._simp2tradi
