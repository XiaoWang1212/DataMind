...
from src.rag.deepdoc.vision import OCR, AscendLayoutRecognizer, LayoutRecognizer, Recognizer, TableStructureRecognizer
from src.rag.app.picture import vision_llm_chunk as picture_vision_llm_chunk
from src.rag.nlp import rag_tokenizer
from src.rag.prompts.generator import vision_llm_describe_prompt
from src.rag.settings import PARALLEL_DEVICES
...
class AIoTersRAGPdfParser:
    def __init__(self, **kwargs):
        ...
        if not settings.LIGHTEN:
            try:
                ...
                logging.exception("AIoTersRAGPdfParser __init__")
        model_dir = os.path.join(get_project_base_directory(), "src/rag/res/deepdoc")
    ...
    def __images__(self, fnm, zoomin=3, page_from=0, page_to=299, callback=None):
        ...
        try:
            ...
            logging.exception("AIoTersRAGPdfParser __images__")
...
class VisionParser(AIoTersRAGPdfParser):
